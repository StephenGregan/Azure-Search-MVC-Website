...
using WebApplicationStephenAzureSearch.Models;
    ...
    public class HomeController : Controller
    {
            ...
            int maxDistance = 0)
        {
            ...
            return new JsonResult
            {
                ...
                Data = new Contact() { Results = response.Results, Facets = response.Facets, Count = Convert.ToInt32(response.Count) }
            };
        }
        ...
        public ActionResult LookUp(string id)
        {
            ...
            if (id != null)
            {
                ...
                {
                    JsonRequestBehavior = JsonRequestBehavior.AllowGet,
                    Data = new ContactLookup() { Result = response }
                };
            }
            else
            {
